...
urlpatterns = [
    ...
    path('t/', views.curriculum, name='curriculum sidebar layout'),
    path('t/<str:parent>', views.curriculum, name='curriculum sidebar layout'),
    path('t/<str:parent>/<str:child>', views.curriculum, name='curriculum sidebar layout'),
